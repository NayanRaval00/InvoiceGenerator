            ...
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    <a href="" class="mb-40 max-w-290-px">
                        <img src="{{asset('assets/media/logos/logo.jpg')}}" alt="">
                    </a>
                ...
                <form method="POST" action="{{ route('custom.login.submit') }}">
                    ...
                    <div class="icon-field mb-16">
                        ...
                        <input type="email" name="email" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Email" id="exampleInputEmail1">
                        @error('email')
                    ...
                    <div class="position-relative mb-20">
                        <div class="icon-field">
                            ...
                            <input type="password" name="password" class="form-control h-56-px bg-neutral-50 radius-12" id="exampleInputPassword1" placeholder="Password">
                            @error('password')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
